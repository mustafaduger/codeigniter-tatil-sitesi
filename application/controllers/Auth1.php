...
class Auth extends CI_Controller {
	...
	public function index()
	{
		...
		else
		{
			...
			/*print_r($this->data);
			die();*/
			$this->load->view('admin/auth/index',$this->data);
	...
	public function login()
	{
		...
		if ($this->form_validation->run() == true)
		{
			...
			else
			{
				...
				$this->session->set_flashdata('message','Geçersiz kullanıcı adı ve/veya parola');
...
*/
	...
	public function logout()
	{
		...
		// redirect them to the login page
		$this->session->set_flashdata('message', 'Başarılı çıkış yaptınız.');
		redirect('auth/login', 'refresh');
	}
	...
	public function create_user_view()
	{
		if (!$this->ion_auth->logged_in() || !$this->ion_auth->is_admin())
        {
        	...
        	$this->load->view('admin/auth/create_user',$this->data);	
        }
    ...
    public function edit_user_view($id)
    {
		...
		$this->load->view('admin/auth/edit_user', $this->data);
...
*/
		...
		$this->load->view('admin/auth/edit_user_view', $this->data);
		//$this->_render_page('admin/auth/edit_user_view', $this->data);
	}
