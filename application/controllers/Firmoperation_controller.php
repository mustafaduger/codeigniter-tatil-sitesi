...
class Firmoperation_controller extends CI_Controller {
	public function __construct()
        {
        		parent::__construct();
                 ...
                 redirect('auth/login');
           		...
           		$this->load->model('firmoperation_model');
	...
	public function index()
	{
		...
		$data['result']=$this->firmoperation_model->getAll_firm();
		$this->load->view('admin/firmoperation/firmoperation',$data);
		
	}

  public function operation_controller($id=null)
  {
    
    $data['result']=$this->firmoperation_model->get_firmbyId($id);
    $this->load->view('admin/firmoperation/operation/operation',$data);
   ...
   public function isActive_set()
    {
      ...
      $this->db->where('firma_id',$id)->update('tbl_firma',array('firma_isActive'=>$isActive));
    }
