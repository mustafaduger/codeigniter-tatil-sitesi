...
<body>
	...
	<main>
	<?php $this->load->view('front/explore/readmore/breadcumb'); ?>
		<!-- End position -->
		<div class="container margin_60">
			<div class="row">
			<aside class="col-md-3 add_bottom_30">
			<?php $this->load->view('front/explore/include/sidebar') ?>
			<?php $this->load->view('front/explore/readmore/tags_widget'); ?>
			</aside>
					<!-- End widget -->
			<!-- End aside -->
    		<?php $this->load->view('front/explore/readmore/main_content'); ?> 
			</div>
			<!-- End row-->
		</div>
		<!-- End container -->
