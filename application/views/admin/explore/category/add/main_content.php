    ...
    <section class="content">
      ...
      <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Keşfet Kategori Ekle</h3>
            </div>
            <!-- /.box-header -->
           <?php echo $this->session->flashdata('login_error'); ?>
            <!-- form start -->

            <form action="<?php echo base_url('categoryexplore_controller/add_category_controller'); ?>" method="post" class="form-horizontal">
              <div class="box-body">
