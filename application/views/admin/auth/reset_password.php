...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg ">Şifre Yenileme</p>
    <?php echo $this->session->flashdata('flash_message'); ?>
   <h5>Merhaba <span><?php echo $firstName; ?></span>,<br> Şifrenizi yenilemek için 2 kere giriniz.</h5>
    <?php 
    ...
    echo form_open(site_url().'auth/reset_password/token/'.$token, $fattr); ?>
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <?php echo form_submit(array('value'=>'Kaydet', 'class'=>'btn btn-primary btn-block btn-flat')); ?>
        <?php echo form_close(); ?>
