              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  ></td>
                   ...
                   <td class="center">
                    <a href="<?php echo base_url('category_controller/edit_category_controller/'.$row->kategori_id.'');?>" class="btn btn-info"><i class="fa fa-pencil"></i></a>
                    
                    <a class="btn btn-danger" onclick="return sor()" href="<?php echo base_url('category_controller/delete_category_controller/'.$row->kategori_id.'') ?>"><i class="fa fa-trash-o"></i></a>
