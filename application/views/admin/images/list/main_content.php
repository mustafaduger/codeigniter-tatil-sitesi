 <!-- Main content -->
    <section class="content">
      ...
      <div class="box box-info">
            ...
            <!-- form start -->
            <form action="<?php echo base_url('images_controller/update_imageslist_controller');?>" enctype= "multipart/form-data" method="post" class="form-horizontal">
              <div class="box-body">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                     <img src="<?php echo base_url($row->resim_list);?>" class="img-thumbnail">
